...
2. Create a plan
   ...
   - Read existing product context (if present)
     - Read files under `.swe/context/` (if the folder exists, include related personas. epics, specs, analyses, stories).
...
6. Write the PRD like a Principal Product Manager
...
7. Act like a Principal UX Designer, and review and improve user experience requirements of the proposal
